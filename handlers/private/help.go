...
func help(b *gotgbot.Bot, c *ext.Context) error {
	c.Message.Reply(
		...
		"First of all, you need to have your news feed link. "+
			...
			"After that, send /add_feed followed by your feed link.\n"+
			"And for removing your feed, simply send /rm_feed followed by its link or /rm_feeds to remove all feeds.",
		nil,
	)
	return nil
}
